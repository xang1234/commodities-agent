...
-- Daily-call briefs: analyst-published morning call (draft -> approved -> published).
-- The sealed snapshot is created at publish time, so snapshot_id is null until then.
